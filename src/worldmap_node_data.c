...
const struct GMapNodeData gWMNodeData[] =
{
    [NODE_BORDER_MULAN] =
    {
        ...
        .unk_06 = 0x0089, // flag - affects whether to use the former 2 or the latter 2 of unk_08 
        .unk_08 = { 0x00, 0x00, 0x01, 0x01, }, // after winning, go to this node (Eirika, Ephraim, EirikaFlagOn, EphraimFlagOn 
    ...
    [NODE_CASTLE_FRELIA] =
    {
        ...
        .iconPreClear = 0x0F,
        .iconPostClear = 0x0F,
        .chapteridx_eirika = CHAPTER_L_1,
        .chapteridx_ephram = CHAPTER_L_1,
        .unk_06 = 0x0088,
        .unk_08 = { 0x02, 0x02, 0x02, 0x02, },
