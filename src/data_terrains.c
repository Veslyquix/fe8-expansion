...
CONST_DATA s8 TerrainTable_MovCost_SoldierT1Normal[] = {
    [TERRAIN_NONE] = -1,
    [TERRAIN_PLAINS] = 1,
    [TERRAIN_ROAD] = 1,
    [TERRAIN_VILLAGE_REGULAR] = 1,
...
/* Soldier never had a dedicated Rain/Snow profile in vanilla (it fell
 * through to CommonT1); this expansion gives it its own weather-neutral
 * table by copying TerrainTable_MovCost_SoldierT1Normal verbatim -- see
 * scripts/sync_terrain_weather.py, which keeps every class's Rain/Snow
 * table in sync with its Normal one and can regenerate this block. */
CONST_DATA s8 TerrainTable_MovCost_SoldierT1Rain[] = {
    [TERRAIN_NONE] = -1,
    [TERRAIN_PLAINS] = 1,
    [TERRAIN_ROAD] = 1,
    [TERRAIN_VILLAGE_REGULAR] = 1,
 ...
 * scripts/sync_terrain_weather.py, which keeps every class's Rain/Snow
 * table in sync with its Normal one and can regenerate this block. */
CONST_DATA s8 TerrainTable_MovCost_SoldierT1Snow[] = {
    [TERRAIN_NONE] = -1,
    [TERRAIN_PLAINS] = 1,
    [TERRAIN_ROAD] = 1,
    [TERRAIN_VILLAGE_REGULAR] = 1,
...
CONST_DATA u16 gTerrains_0[] = {
    ...
    [TERRAIN_FLOOR_MAGIC] = MSG_TERRAIN_CAMP, // repurposed for Camp (PURCHASE_BASE_KIND_CAMP, src/bmtrick.c) -- unused in vanilla FE8
