...
#define DangerBonesBuffer ((u8 *)gBanimOamr2)
...
int ShakeIt = 1;
int Pal_4th = 1;
int ShakeSpeed_Link = 4;
int DB_Pal_ID = 0x9;
int DangerBonesDisabledFlag = 0x128;
const u16 gPal_DangerBones[] = {
    0x1D90, 0x000D, 0x2518, 0x2DDC, 0x000E, 0x00F6, 0x365F, 0x000C,
    0x0015, 0x001C, 0x001F, 0x01C7, 0x015F, 0x0050, 0x461F, 0x0008,
};
...
{
    int mask = 1 << ShakeSpeed_Link;

    return (GetGameClock() & mask) >> ShakeSpeed_Link;
}
