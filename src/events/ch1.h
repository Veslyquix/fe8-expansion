...
CONST_DATA EventScr EventScrWM_Ch1_Beginning[] = {
    EVBIT_MODIFY(0x1)
    WM_SPAWNLORD(WM_MU_0, CHARACTER_EIRIKA, WM_NODE_BorderMulan) // NODE 
    ...
    WM_WAITFORFX
    STAL(40)
    WM_DRAWPATH(WM_PATH_00) // PATH 
    WM_MOVESPRITETO(WM_MU_0, 0x0002, WM_NODE_BorderMulan, WM_NODE_CastleFrelia, 200, 30)
