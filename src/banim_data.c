...
struct BattleAnim banim_data[] = {
    ...
    {"newhrbasw1", &banim_newhrba_sword_modes_bin, &banim_newhrba_sword_script_o, &banim_newhrba_sword_oam_bin, &banim_newhrba_sword_oam_bin, &banim_newhrba_sword_agbpal}, // 0x12A hrba sword
    {"newhrbaln1", &banim_newhrba_lance_modes_bin, &banim_newhrba_lance_script_o, &banim_newhrba_lance_oam_bin, &banim_newhrba_lance_oam_bin, &banim_newhrba_lance_agbpal}, // 0x12B hrba lance
    {"newhrbaax1", &banim_newhrba_axe_modes_bin, &banim_newhrba_axe_script_o, &banim_newhrba_axe_oam_bin, &banim_newhrba_axe_oam_bin, &banim_newhrba_axe_agbpal}, // 0x12C hrba axe
    {"newhrbahx1", &banim_newhrba_handaxe_modes_bin, &banim_newhrba_handaxe_script_o, &banim_newhrba_handaxe_oam_bin, &banim_newhrba_handaxe_oam_bin, &banim_newhrba_handaxe_agbpal}, // 0x12D hrba handaxe
    {"newhrbast1", &banim_newhrba_staff_modes_bin, &banim_newhrba_staff_script_o, &banim_newhrba_staff_oam_bin, &banim_newhrba_staff_oam_bin, &banim_newhrba_staff_agbpal}, // 0x12E hrba staff
    {"newhrbamg1", &banim_newhrba_magic_modes_bin, &banim_newhrba_magic_script_o, &banim_newhrba_magic_oam_bin, &banim_newhrba_magic_oam_bin, &banim_newhrba_magic_agbpal}, // 0x12F hrba magic
    {"newhrbaun1", &banim_newhrba_unarmed_modes_bin, &banim_newhrba_unarmed_script_o, &banim_newhrba_unarmed_oam_bin, &banim_newhrba_unarmed_oam_bin, &banim_newhrba_unarmed_agbpal}, // 0x130 hrba unarmed
    {"newhvinsw1", &banim_newhvin_sword_modes_bin, &banim_newhvin_sword_script_o, &banim_newhvin_sword_oam_bin, &banim_newhvin_sword_oam_bin, &banim_newhvin_sword_agbpal}, // 0x131 hvin sword
    {"newhvinln1", &banim_newhvin_lance_modes_bin, &banim_newhvin_lance_script_o, &banim_newhvin_lance_oam_bin, &banim_newhvin_lance_oam_bin, &banim_newhvin_lance_agbpal}, // 0x132 hvin lance
    {"newhvinax1", &banim_newhvin_axe_modes_bin, &banim_newhvin_axe_script_o, &banim_newhvin_axe_oam_bin, &banim_newhvin_axe_oam_bin, &banim_newhvin_axe_agbpal}, // 0x133 hvin axe
    {"newhvinhx1", &banim_newhvin_handaxe_modes_bin, &banim_newhvin_handaxe_script_o, &banim_newhvin_handaxe_oam_bin, &banim_newhvin_handaxe_oam_bin, &banim_newhvin_handaxe_agbpal}, // 0x134 hvin handaxe
    {"newhvinun1", &banim_newhvin_unarmed_modes_bin, &banim_newhvin_unarmed_script_o, &banim_newhvin_unarmed_oam_bin, &banim_newhvin_unarmed_oam_bin, &banim_newhvin_unarmed_agbpal}, // 0x135 hvin unarmed
    {"newbarosw1", &banim_newbaro_sword_modes_bin, &banim_newbaro_sword_script_o, &banim_newbaro_sword_oam_bin, &banim_newbaro_sword_oam_bin, &banim_newbaro_sword_agbpal}, // 0x136 baro sword
    {"newbaroln1", &banim_newbaro_lance_modes_bin, &banim_newbaro_lance_script_o, &banim_newbaro_lance_oam_bin, &banim_newbaro_lance_oam_bin, &banim_newbaro_lance_agbpal}, // 0x137 baro lance
    {"newbaroax1", &banim_newbaro_axe_modes_bin, &banim_newbaro_axe_script_o, &banim_newbaro_axe_oam_bin, &banim_newbaro_axe_oam_bin, &banim_newbaro_axe_agbpal}, // 0x138 baro axe
    {"newbarohx1", &banim_newbaro_handaxe_modes_bin, &banim_newbaro_handaxe_script_o, &banim_newbaro_handaxe_oam_bin, &banim_newbaro_handaxe_oam_bin, &banim_newbaro_handaxe_agbpal}, // 0x139 baro handaxe
    {"newbarobw1", &banim_newbaro_bow_modes_bin, &banim_newbaro_bow_script_o, &banim_newbaro_bow_oam_bin, &banim_newbaro_bow_oam_bin, &banim_newbaro_bow_agbpal}, // 0x13A baro bow
    {"newbarost1", &banim_newbaro_staff_modes_bin, &banim_newbaro_staff_script_o, &banim_newbaro_staff_oam_bin, &banim_newbaro_staff_oam_bin, &banim_newbaro_staff_agbpal}, // 0x13B baro staff
    {"newbaromg1", &banim_newbaro_magic_modes_bin, &banim_newbaro_magic_script_o, &banim_newbaro_magic_oam_bin, &banim_newbaro_magic_oam_bin, &banim_newbaro_magic_agbpal}, // 0x13C baro magic
    {"newshgnsw1", &banim_newshgn_sword_modes_bin, &banim_newshgn_sword_script_o, &banim_newshgn_sword_oam_bin, &banim_newshgn_sword_oam_bin, &banim_newshgn_sword_agbpal}, // 0x13D shgn sword
    {"newshgnln1", &banim_newshgn_lance_modes_bin, &banim_newshgn_lance_script_o, &banim_newshgn_lance_oam_bin, &banim_newshgn_lance_oam_bin, &banim_newshgn_lance_agbpal}, // 0x13E shgn lance
    {"newshgnax1", &banim_newshgn_axe_modes_bin, &banim_newshgn_axe_script_o, &banim_newshgn_axe_oam_bin, &banim_newshgn_axe_oam_bin, &banim_newshgn_axe_agbpal}, // 0x13F shgn axe
    {"newshgnhx1", &banim_newshgn_handaxe_modes_bin, &banim_newshgn_handaxe_script_o, &banim_newshgn_handaxe_oam_bin, &banim_newshgn_handaxe_oam_bin, &banim_newshgn_handaxe_agbpal}, // 0x140 shgn handaxe
    {"newshgnmg1", &banim_newshgn_magic_modes_bin, &banim_newshgn_magic_script_o, &banim_newshgn_magic_oam_bin, &banim_newshgn_magic_oam_bin, &banim_newshgn_magic_agbpal}, // 0x141 shgn magic
    {"newshgnun1", &banim_newshgn_unarmed_modes_bin, &banim_newshgn_unarmed_script_o, &banim_newshgn_unarmed_oam_bin, &banim_newshgn_unarmed_oam_bin, &banim_newshgn_unarmed_agbpal}, // 0x142 shgn unarmed
    {"newbdrgun1", &banim_newbdrg_unarmed_modes_bin, &banim_newbdrg_unarmed_script_o, &banim_newbdrg_unarmed_oam_bin, &banim_newbdrg_unarmed_oam_bin, &banim_newbdrg_unarmed_agbpal}, // 0x143 bdrg unarmed
    {"newbdrgdr1", &banim_newbdrg_dragonstone_modes_bin, &banim_newbdrg_dragonstone_script_o, &banim_newbdrg_dragonstone_oam_bin, &banim_newbdrg_dragonstone_oam_bin, &banim_newbdrg_dragonstone_agbpal}, // 0x144 bdrg dragonstone
    {"newdjinsw1", &banim_newdjin_sword_modes_bin, &banim_newdjin_sword_script_o, &banim_newdjin_sword_oam_bin, &banim_newdjin_sword_oam_bin, &banim_newdjin_sword_agbpal}, // 0x145 djin sword
    {"newdjinmg1", &banim_newdjin_magic_modes_bin, &banim_newdjin_magic_script_o, &banim_newdjin_magic_oam_bin, &banim_newdjin_magic_oam_bin, &banim_newdjin_magic_agbpal}, // 0x146 djin magic
    {"newdjinsu1", &banim_newdjin_supply_modes_bin, &banim_newdjin_supply_script_o, &banim_newdjin_supply_oam_bin, &banim_newdjin_supply_oam_bin, &banim_newdjin_supply_agbpal}, // 0x147 djin supply
    {"newlarmsw1", &banim_newlarm_sword_modes_bin, &banim_newlarm_sword_script_o, &banim_newlarm_sword_oam_bin, &banim_newlarm_sword_oam_bin, &banim_newlarm_sword_agbpal}, // 0x148 larm sword
    {"newlarmax1", &banim_newlarm_axe_modes_bin, &banim_newlarm_axe_script_o, &banim_newlarm_axe_oam_bin, &banim_newlarm_axe_oam_bin, &banim_newlarm_axe_agbpal}, // 0x149 larm axe
    {"newlarmhx1", &banim_newlarm_handaxe_modes_bin, &banim_newlarm_handaxe_script_o, &banim_newlarm_handaxe_oam_bin, &banim_newlarm_handaxe_oam_bin, &banim_newlarm_handaxe_agbpal}, // 0x14A larm handaxe
    {"newlarmun1", &banim_newlarm_unarmed_modes_bin, &banim_newlarm_unarmed_script_o, &banim_newlarm_unarmed_oam_bin, &banim_newlarm_unarmed_oam_bin, &banim_newlarm_unarmed_agbpal}, // 0x14B larm unarmed
    {"newfellmg1", &banim_newfell_magic_modes_bin, &banim_newfell_magic_script_o, &banim_newfell_magic_oam_bin, &banim_newfell_magic_oam_bin, &banim_newfell_magic_agbpal}, // 0x14C fell magic
    {"newfellmo1", &banim_newfell_monster_modes_bin, &banim_newfell_monster_script_o, &banim_newfell_monster_oam_bin, &banim_newfell_monster_oam_bin, &banim_newfell_monster_agbpal}, // 0x14D fell monster
    {"newsamfsw1", &banim_newsamf_sword_modes_bin, &banim_newsamf_sword_script_o, &banim_newsamf_sword_oam_bin, &banim_newsamf_sword_oam_bin, &banim_newsamf_sword_agbpal}, // 0x14E samf sword
    {"newsamfun1", &banim_newsamf_unarmed_modes_bin, &banim_newsamf_unarmed_script_o, &banim_newsamf_unarmed_oam_bin, &banim_newsamf_unarmed_oam_bin, &banim_newsamf_unarmed_agbpal}, // 0x14F samf unarmed
    {"newmnjasw1", &banim_newmnja_sword_modes_bin, &banim_newmnja_sword_script_o, &banim_newmnja_sword_oam_bin, &banim_newmnja_sword_oam_bin, &banim_newmnja_sword_agbpal}, // 0x150 mnja sword
    {"newmnjaun1", &banim_newmnja_unarmed_modes_bin, &banim_newmnja_unarmed_script_o, &banim_newmnja_unarmed_oam_bin, &banim_newmnja_unarmed_oam_bin, &banim_newmnja_unarmed_agbpal}, // 0x151 mnja unarmed
    {"newhnjasw1", &banim_newhnja_sword_modes_bin, &banim_newhnja_sword_script_o, &banim_newhnja_sword_oam_bin, &banim_newhnja_sword_oam_bin, &banim_newhnja_sword_agbpal}, // 0x152 hnja sword
    {"newhnjaun1", &banim_newhnja_unarmed_modes_bin, &banim_newhnja_unarmed_script_o, &banim_newhnja_unarmed_oam_bin, &banim_newhnja_unarmed_oam_bin, &banim_newhnja_unarmed_agbpal}, // 0x153 hnja unarmed
    {"newmyffsw1", &banim_newmyff_sword_modes_bin, &banim_newmyff_sword_script_o, &banim_newmyff_sword_oam_bin, &banim_newmyff_sword_oam_bin, &banim_newmyff_sword_agbpal}, // 0x154 myff sword
    {"newmyffun1", &banim_newmyff_unarmed_modes_bin, &banim_newmyff_unarmed_script_o, &banim_newmyff_unarmed_oam_bin, &banim_newmyff_unarmed_oam_bin, &banim_newmyff_unarmed_agbpal}, // 0x155 myff unarmed
    {"newmyfmsw1", &banim_newmyfm_sword_modes_bin, &banim_newmyfm_sword_script_o, &banim_newmyfm_sword_oam_bin, &banim_newmyfm_sword_oam_bin, &banim_newmyfm_sword_agbpal}, // 0x156 myfm sword
    {"newmyfmun1", &banim_newmyfm_unarmed_modes_bin, &banim_newmyfm_unarmed_script_o, &banim_newmyfm_unarmed_oam_bin, &banim_newmyfm_unarmed_oam_bin, &banim_newmyfm_unarmed_agbpal}, // 0x157 myfm unarmed
    {"newkatasw1", &banim_newkata_sword_modes_bin, &banim_newkata_sword_script_o, &banim_newkata_sword_oam_bin, &banim_newkata_sword_oam_bin, &banim_newkata_sword_agbpal}, // 0x158 kata sword
    {"newkataun1", &banim_newkata_unarmed_modes_bin, &banim_newkata_unarmed_script_o, &banim_newkata_unarmed_oam_bin, &banim_newkata_unarmed_oam_bin, &banim_newkata_unarmed_agbpal}, // 0x159 kata unarmed
    {"newthugsw1", &banim_newthug_sword_modes_bin, &banim_newthug_sword_script_o, &banim_newthug_sword_oam_bin, &banim_newthug_sword_oam_bin, &banim_newthug_sword_agbpal}, // 0x15A thug sword
    {"newthugun1", &banim_newthug_unarmed_modes_bin, &banim_newthug_unarmed_script_o, &banim_newthug_unarmed_oam_bin, &banim_newthug_unarmed_oam_bin, &banim_newthug_unarmed_agbpal}, // 0x15B thug unarmed
    {"newdrdfsw1", &banim_newdrdf_sword_modes_bin, &banim_newdrdf_sword_script_o, &banim_newdrdf_sword_oam_bin, &banim_newdrdf_sword_oam_bin, &banim_newdrdf_sword_agbpal}, // 0x15C drdf sword
    {"newdrdfmg1", &banim_newdrdf_magic_modes_bin, &banim_newdrdf_magic_script_o, &banim_newdrdf_magic_oam_bin, &banim_newdrdf_magic_oam_bin, &banim_newdrdf_magic_agbpal}, // 0x15D drdf magic
    {"newdrdfun1", &banim_newdrdf_unarmed_modes_bin, &banim_newdrdf_unarmed_script_o, &banim_newdrdf_unarmed_oam_bin, &banim_newdrdf_unarmed_oam_bin, &banim_newdrdf_unarmed_agbpal}, // 0x15E drdf unarmed
    {"newfirssw1", &banim_newfirs_sword_modes_bin, &banim_newfirs_sword_script_o, &banim_newfirs_sword_oam_bin, &banim_newfirs_sword_oam_bin, &banim_newfirs_sword_agbpal}, // 0x15F firs sword
    {"newfirsln1", &banim_newfirs_lance_modes_bin, &banim_newfirs_lance_script_o, &banim_newfirs_lance_oam_bin, &banim_newfirs_lance_oam_bin, &banim_newfirs_lance_agbpal}, // 0x160 firs lance
    {"newfirsun1", &banim_newfirs_unarmed_modes_bin, &banim_newfirs_unarmed_script_o, &banim_newfirs_unarmed_oam_bin, &banim_newfirs_unarmed_oam_bin, &banim_newfirs_unarmed_agbpal}, // 0x161 firs unarmed
    {"newtrubsw1", &banim_newtrub_sword_modes_bin, &banim_newtrub_sword_script_o, &banim_newtrub_sword_oam_bin, &banim_newtrub_sword_oam_bin, &banim_newtrub_sword_agbpal}, // 0x162 trub sword
    {"newtrubun1", &banim_newtrub_unarmed_modes_bin, &banim_newtrub_unarmed_script_o, &banim_newtrub_unarmed_oam_bin, &banim_newtrub_unarmed_oam_bin, &banim_newtrub_unarmed_agbpal}, // 0x163 trub unarmed
    {"newredmsw1", &banim_newredm_sword_modes_bin, &banim_newredm_sword_script_o, &banim_newredm_sword_oam_bin, &banim_newredm_sword_oam_bin, &banim_newredm_sword_agbpal}, // 0x164 redm sword
    {"newredmst1", &banim_newredm_staff_modes_bin, &banim_newredm_staff_script_o, &banim_newredm_staff_oam_bin, &banim_newredm_staff_oam_bin, &banim_newredm_staff_agbpal}, // 0x165 redm staff
    {"newredmmg1", &banim_newredm_magic_modes_bin, &banim_newredm_magic_script_o, &banim_newredm_magic_oam_bin, &banim_newredm_magic_oam_bin, &banim_newredm_magic_agbpal}, // 0x166 redm magic
    {"newmololn1", &banim_newmolo_lance_modes_bin, &banim_newmolo_lance_script_o, &banim_newmolo_lance_oam_bin, &banim_newmolo_lance_oam_bin, &banim_newmolo_lance_agbpal}, // 0x167 molo lance
    {"newmolost1", &banim_newmolo_staff_modes_bin, &banim_newmolo_staff_script_o, &banim_newmolo_staff_oam_bin, &banim_newmolo_staff_oam_bin, &banim_newmolo_staff_agbpal}, // 0x168 molo staff
    {"newmolomg1", &banim_newmolo_magic_modes_bin, &banim_newmolo_magic_script_o, &banim_newmolo_magic_oam_bin, &banim_newmolo_magic_oam_bin, &banim_newmolo_magic_agbpal}, // 0x169 molo magic
    {"newmoloun1", &banim_newmolo_unarmed_modes_bin, &banim_newmolo_unarmed_script_o, &banim_newmolo_unarmed_oam_bin, &banim_newmolo_unarmed_oam_bin, &banim_newmolo_unarmed_agbpal}, // 0x16A molo unarmed
    {"newtactmg1", &banim_newtact_magic_modes_bin, &banim_newtact_magic_script_o, &banim_newtact_magic_oam_bin, &banim_newtact_magic_oam_bin, &banim_newtact_magic_agbpal}, // 0x16B tact magic
    {"newtrifsw1", &banim_newtrif_sword_modes_bin, &banim_newtrif_sword_script_o, &banim_newtrif_sword_oam_bin, &banim_newtrif_sword_oam_bin, &banim_newtrif_sword_agbpal}, // 0x16C trif sword
    {"newtrifbw1", &banim_newtrif_bow_modes_bin, &banim_newtrif_bow_script_o, &banim_newtrif_bow_oam_bin, &banim_newtrif_bow_oam_bin, &banim_newtrif_bow_agbpal}, // 0x16D trif bow
    {"newtrifst1", &banim_newtrif_staff_modes_bin, &banim_newtrif_staff_script_o, &banim_newtrif_staff_oam_bin, &banim_newtrif_staff_oam_bin, &banim_newtrif_staff_agbpal}, // 0x16E trif staff
    {"newtrifmg1", &banim_newtrif_magic_modes_bin, &banim_newtrif_magic_script_o, &banim_newtrif_magic_oam_bin, &banim_newtrif_magic_oam_bin, &banim_newtrif_magic_agbpal}, // 0x16F trif magic
    {"newtrimsw1", &banim_newtrim_sword_modes_bin, &banim_newtrim_sword_script_o, &banim_newtrim_sword_oam_bin, &banim_newtrim_sword_oam_bin, &banim_newtrim_sword_agbpal}, // 0x170 trim sword
    {"newtrimbw1", &banim_newtrim_bow_modes_bin, &banim_newtrim_bow_script_o, &banim_newtrim_bow_oam_bin, &banim_newtrim_bow_oam_bin, &banim_newtrim_bow_agbpal}, // 0x171 trim bow
    {"newtrimst1", &banim_newtrim_staff_modes_bin, &banim_newtrim_staff_script_o, &banim_newtrim_staff_oam_bin, &banim_newtrim_staff_oam_bin, &banim_newtrim_staff_agbpal}, // 0x172 trim staff
    {"newtrimmg1", &banim_newtrim_magic_modes_bin, &banim_newtrim_magic_script_o, &banim_newtrim_magic_oam_bin, &banim_newtrim_magic_oam_bin, &banim_newtrim_magic_agbpal}, // 0x173 trim magic
    {"newvilfsw1", &banim_newvilf_sword_modes_bin, &banim_newvilf_sword_script_o, &banim_newvilf_sword_oam_bin, &banim_newvilf_sword_oam_bin, &banim_newvilf_sword_agbpal}, // 0x174 vilf sword
    {"newvilfun1", &banim_newvilf_unarmed_modes_bin, &banim_newvilf_unarmed_script_o, &banim_newvilf_unarmed_oam_bin, &banim_newvilf_unarmed_oam_bin, &banim_newvilf_unarmed_agbpal}, // 0x175 vilf unarmed
    {"newvilmsw1", &banim_newvilm_sword_modes_bin, &banim_newvilm_sword_script_o, &banim_newvilm_sword_oam_bin, &banim_newvilm_sword_oam_bin, &banim_newvilm_sword_agbpal}, // 0x176 vilm sword
    {"newvilmun1", &banim_newvilm_unarmed_modes_bin, &banim_newvilm_unarmed_script_o, &banim_newvilm_unarmed_oam_bin, &banim_newvilm_unarmed_oam_bin, &banim_newvilm_unarmed_agbpal}, // 0x177 vilm unarmed
    {"newlegksw1", &banim_newlegk_sword_modes_bin, &banim_newlegk_sword_script_o, &banim_newlegk_sword_oam_bin, &banim_newlegk_sword_oam_bin, &banim_newlegk_sword_agbpal}, // 0x178 legk sword
    {"newlegkln1", &banim_newlegk_lance_modes_bin, &banim_newlegk_lance_script_o, &banim_newlegk_lance_oam_bin, &banim_newlegk_lance_oam_bin, &banim_newlegk_lance_agbpal}, // 0x179 legk lance
    {"newlegkax1", &banim_newlegk_axe_modes_bin, &banim_newlegk_axe_script_o, &banim_newlegk_axe_oam_bin, &banim_newlegk_axe_oam_bin, &banim_newlegk_axe_agbpal}, // 0x17A legk axe
    {"newlegkhx1", &banim_newlegk_handaxe_modes_bin, &banim_newlegk_handaxe_script_o, &banim_newlegk_handaxe_oam_bin, &banim_newlegk_handaxe_oam_bin, &banim_newlegk_handaxe_agbpal}, // 0x17B legk handaxe
    {"newlegkmg1", &banim_newlegk_magic_modes_bin, &banim_newlegk_magic_script_o, &banim_newlegk_magic_oam_bin, &banim_newlegk_magic_oam_bin, &banim_newlegk_magic_agbpal}, // 0x17C legk magic
    {"newlegkun1", &banim_newlegk_unarmed_modes_bin, &banim_newlegk_unarmed_script_o, &banim_newlegk_unarmed_oam_bin, &banim_newlegk_unarmed_oam_bin, &banim_newlegk_unarmed_agbpal}, // 0x17D legk unarmed
    {"newonicax1", &banim_newonic_axe_modes_bin, &banim_newonic_axe_script_o, &banim_newonic_axe_oam_bin, &banim_newonic_axe_oam_bin, &banim_newonic_axe_agbpal}, // 0x17E onic axe
    {"newonichx1", &banim_newonic_handaxe_modes_bin, &banim_newonic_handaxe_script_o, &banim_newonic_handaxe_oam_bin, &banim_newonic_handaxe_oam_bin, &banim_newonic_handaxe_agbpal}, // 0x17F onic handaxe
    {"newonicmg1", &banim_newonic_magic_modes_bin, &banim_newonic_magic_script_o, &banim_newonic_magic_oam_bin, &banim_newonic_magic_oam_bin, &banim_newonic_magic_agbpal}, // 0x180 onic magic
    {"newelfnmg1", &banim_newelfn_magic_modes_bin, &banim_newelfn_magic_script_o, &banim_newelfn_magic_oam_bin, &banim_newelfn_magic_oam_bin, &banim_newelfn_magic_agbpal}, // 0x181 elfn magic
    {"newelfnrf1", &banim_newelfn_refresh_modes_bin, &banim_newelfn_refresh_script_o, &banim_newelfn_refresh_oam_bin, &banim_newelfn_refresh_oam_bin, &banim_newelfn_refresh_agbpal}, // 0x182 elfn refresh
    {"newmmarax1", &banim_newmmar_axe_modes_bin, &banim_newmmar_axe_script_o, &banim_newmmar_axe_oam_bin, &banim_newmmar_axe_oam_bin, &banim_newmmar_axe_agbpal}, // 0x183 mmar axe
    {"newmmarhx1", &banim_newmmar_handaxe_modes_bin, &banim_newmmar_handaxe_script_o, &banim_newmmar_handaxe_oam_bin, &banim_newmmar_handaxe_oam_bin, &banim_newmmar_handaxe_agbpal}, // 0x184 mmar handaxe
    {"newmmarbw1", &banim_newmmar_bow_modes_bin, &banim_newmmar_bow_script_o, &banim_newmmar_bow_oam_bin, &banim_newmmar_bow_oam_bin, &banim_newmmar_bow_agbpal}, // 0x185 mmar bow
    {"newmmarun1", &banim_newmmar_unarmed_modes_bin, &banim_newmmar_unarmed_script_o, &banim_newmmar_unarmed_oam_bin, &banim_newmmar_unarmed_oam_bin, &banim_newmmar_unarmed_agbpal}, // 0x186 mmar unarmed
    {"newmechbw1", &banim_newmech_bow_modes_bin, &banim_newmech_bow_script_o, &banim_newmech_bow_oam_bin, &banim_newmech_bow_oam_bin, &banim_newmech_bow_agbpal}, // 0x187 mech bow
    {"newmechun1", &banim_newmech_unarmed_modes_bin, &banim_newmech_unarmed_script_o, &banim_newmech_unarmed_oam_bin, &banim_newmech_unarmed_oam_bin, &banim_newmech_unarmed_agbpal}, // 0x188 mech unarmed
    {"newdragln1", &banim_newdrag_lance_modes_bin, &banim_newdrag_lance_script_o, &banim_newdrag_lance_oam_bin, &banim_newdrag_lance_oam_bin, &banim_newdrag_lance_agbpal}, // 0x189 drag lance
    {"newdragun1", &banim_newdrag_unarmed_modes_bin, &banim_newdrag_unarmed_script_o, &banim_newdrag_unarmed_oam_bin, &banim_newdrag_unarmed_oam_bin, &banim_newdrag_unarmed_agbpal}, // 0x18A drag unarmed
    {"newlancln1", &banim_newlanc_lance_modes_bin, &banim_newlanc_lance_script_o, &banim_newlanc_lance_oam_bin, &banim_newlanc_lance_oam_bin, &banim_newlanc_lance_agbpal}, // 0x18B lanc lance
    {"newlancun1", &banim_newlanc_unarmed_modes_bin, &banim_newlanc_unarmed_script_o, &banim_newlanc_unarmed_oam_bin, &banim_newlanc_unarmed_oam_bin, &banim_newlanc_unarmed_agbpal}, // 0x18C lanc unarmed
    {"newmiltln1", &banim_newmilt_lance_modes_bin, &banim_newmilt_lance_script_o, &banim_newmilt_lance_oam_bin, &banim_newmilt_lance_oam_bin, &banim_newmilt_lance_agbpal}, // 0x18D milt lance
    {"newmiltun1", &banim_newmilt_unarmed_modes_bin, &banim_newmilt_unarmed_script_o, &banim_newmilt_unarmed_oam_bin, &banim_newmilt_unarmed_oam_bin, &banim_newmilt_unarmed_agbpal}, // 0x18E milt unarmed
    {"newsentsw1", &banim_newsent_sword_modes_bin, &banim_newsent_sword_script_o, &banim_newsent_sword_oam_bin, &banim_newsent_sword_oam_bin, &banim_newsent_sword_agbpal}, // 0x18F sent sword
    {"newsentln1", &banim_newsent_lance_modes_bin, &banim_newsent_lance_script_o, &banim_newsent_lance_oam_bin, &banim_newsent_lance_oam_bin, &banim_newsent_lance_agbpal}, // 0x190 sent lance
    {"newsentax1", &banim_newsent_axe_modes_bin, &banim_newsent_axe_script_o, &banim_newsent_axe_oam_bin, &banim_newsent_axe_oam_bin, &banim_newsent_axe_agbpal}, // 0x191 sent axe
    {"newsenthx1", &banim_newsent_handaxe_modes_bin, &banim_newsent_handaxe_script_o, &banim_newsent_handaxe_oam_bin, &banim_newsent_handaxe_oam_bin, &banim_newsent_handaxe_agbpal}, // 0x192 sent handaxe
    {"newsentun1", &banim_newsent_unarmed_modes_bin, &banim_newsent_unarmed_script_o, &banim_newsent_unarmed_oam_bin, &banim_newsent_unarmed_oam_bin, &banim_newsent_unarmed_agbpal}, // 0x193 sent unarmed
    {"newt1lnsw1", &banim_newt1ln_sword_modes_bin, &banim_newt1ln_sword_script_o, &banim_newt1ln_sword_oam_bin, &banim_newt1ln_sword_oam_bin, &banim_newt1ln_sword_agbpal}, // 0x194 t1ln sword
    {"newt1lnln1", &banim_newt1ln_lance_modes_bin, &banim_newt1ln_lance_script_o, &banim_newt1ln_lance_oam_bin, &banim_newt1ln_lance_oam_bin, &banim_newt1ln_lance_agbpal}, // 0x195 t1ln lance
    {"newt1lnun1", &banim_newt1ln_unarmed_modes_bin, &banim_newt1ln_unarmed_script_o, &banim_newt1ln_unarmed_oam_bin, &banim_newt1ln_unarmed_oam_bin, &banim_newt1ln_unarmed_agbpal}, // 0x196 t1ln unarmed
    {"newgladsw1", &banim_newglad_sword_modes_bin, &banim_newglad_sword_script_o, &banim_newglad_sword_oam_bin, &banim_newglad_sword_oam_bin, &banim_newglad_sword_agbpal}, // 0x197 glad sword
    {"newgladax1", &banim_newglad_axe_modes_bin, &banim_newglad_axe_script_o, &banim_newglad_axe_oam_bin, &banim_newglad_axe_oam_bin, &banim_newglad_axe_agbpal}, // 0x198 glad axe
    {"newgladhx1", &banim_newglad_handaxe_modes_bin, &banim_newglad_handaxe_script_o, &banim_newglad_handaxe_oam_bin, &banim_newglad_handaxe_oam_bin, &banim_newglad_handaxe_agbpal}, // 0x199 glad handaxe
    {"newgladun1", &banim_newglad_unarmed_modes_bin, &banim_newglad_unarmed_script_o, &banim_newglad_unarmed_oam_bin, &banim_newglad_unarmed_oam_bin, &banim_newglad_unarmed_agbpal}, // 0x19A glad unarmed
    {"newhbrgax1", &banim_newhbrg_axe_modes_bin, &banim_newhbrg_axe_script_o, &banim_newhbrg_axe_oam_bin, &banim_newhbrg_axe_oam_bin, &banim_newhbrg_axe_agbpal}, // 0x19B hbrg axe
    {"newhsldln1", &banim_newhsld_lance_modes_bin, &banim_newhsld_lance_script_o, &banim_newhsld_lance_oam_bin, &banim_newhsld_lance_oam_bin, &banim_newhsld_lance_agbpal}, // 0x19C hsld lance
    {"newhuntbw1", &banim_newhunt_bow_modes_bin, &banim_newhunt_bow_script_o, &banim_newhunt_bow_oam_bin, &banim_newhunt_bow_oam_bin, &banim_newhunt_bow_agbpal}, // 0x19D hunt bow
    {"newhuntun1", &banim_newhunt_unarmed_modes_bin, &banim_newhunt_unarmed_script_o, &banim_newhunt_unarmed_oam_bin, &banim_newhunt_unarmed_oam_bin, &banim_newhunt_unarmed_agbpal}, // 0x19E hunt unarmed
    {"newannaln1", &banim_newanna_lance_modes_bin, &banim_newanna_lance_script_o, &banim_newanna_lance_oam_bin, &banim_newanna_lance_oam_bin, &banim_newanna_lance_agbpal}, // 0x19F anna lance
    {"newannabw1", &banim_newanna_bow_modes_bin, &banim_newanna_bow_script_o, &banim_newanna_bow_oam_bin, &banim_newanna_bow_oam_bin, &banim_newanna_bow_agbpal}, // 0x1A0 anna bow
    {"newannast1", &banim_newanna_staff_modes_bin, &banim_newanna_staff_script_o, &banim_newanna_staff_oam_bin, &banim_newanna_staff_oam_bin, &banim_newanna_staff_agbpal}, // 0x1A1 anna staff
    {"newsandmo1", &banim_newsand_monster_modes_bin, &banim_newsand_monster_script_o, &banim_newsand_monster_oam_bin, &banim_newsand_monster_oam_bin, &banim_newsand_monster_agbpal}, // 0x1A2 sand monster
    {"newcswdsw1", &banim_newcswd_sword_modes_bin, &banim_newcswd_sword_script_o, &banim_newcswd_sword_oam_bin, &banim_newcswd_sword_oam_bin, &banim_newcswd_sword_agbpal}, // 0x1A3 cswd sword
    {"newtomemg1", &banim_newtome_magic_modes_bin, &banim_newtome_magic_script_o, &banim_newtome_magic_oam_bin, &banim_newtome_magic_oam_bin, &banim_newtome_magic_agbpal}, // 0x1A4 tome magic
    {"newmimcmg1", &banim_newmimc_magic_modes_bin, &banim_newmimc_magic_script_o, &banim_newmimc_magic_oam_bin, &banim_newmimc_magic_oam_bin, &banim_newmimc_magic_agbpal}, // 0x1A5 mimc magic
    {"newmosqmo1", &banim_newmosq_monster_modes_bin, &banim_newmosq_monster_script_o, &banim_newmosq_monster_oam_bin, &banim_newmosq_monster_oam_bin, &banim_newmosq_monster_agbpal}, // 0x1A6 mosq monster
    {"newphntax1", &banim_newphnt_axe_modes_bin, &banim_newphnt_axe_script_o, &banim_newphnt_axe_oam_bin, &banim_newphnt_axe_oam_bin, &banim_newphnt_axe_agbpal}, // 0x1A7 phnt axe
    {"newphnthx1", &banim_newphnt_handaxe_modes_bin, &banim_newphnt_handaxe_script_o, &banim_newphnt_handaxe_oam_bin, &banim_newphnt_handaxe_oam_bin, &banim_newphnt_handaxe_agbpal}, // 0x1A8 phnt handaxe
    {"newphntun1", &banim_newphnt_unarmed_modes_bin, &banim_newphnt_unarmed_script_o, &banim_newphnt_unarmed_oam_bin, &banim_newphnt_unarmed_oam_bin, &banim_newphnt_unarmed_agbpal}, // 0x1A9 phnt unarmed
    {"newslimst1", &banim_newslim_staff_modes_bin, &banim_newslim_staff_script_o, &banim_newslim_staff_oam_bin, &banim_newslim_staff_oam_bin, &banim_newslim_staff_agbpal}, // 0x1AA slim staff
    {"newslimmg1", &banim_newslim_magic_modes_bin, &banim_newslim_magic_script_o, &banim_newslim_magic_oam_bin, &banim_newslim_magic_oam_bin, &banim_newslim_magic_agbpal}, // 0x1AB slim magic
    {"newwbrdln1", &banim_newwbrd_lance_modes_bin, &banim_newwbrd_lance_script_o, &banim_newwbrd_lance_oam_bin, &banim_newwbrd_lance_oam_bin, &banim_newwbrd_lance_agbpal}, // 0x1AC wbrd lance
    {"newwbrdbw1", &banim_newwbrd_bow_modes_bin, &banim_newwbrd_bow_script_o, &banim_newwbrd_bow_oam_bin, &banim_newwbrd_bow_oam_bin, &banim_newwbrd_bow_agbpal}, // 0x1AD wbrd bow
    {"newwbrdun1", &banim_newwbrd_unarmed_modes_bin, &banim_newwbrd_unarmed_script_o, &banim_newwbrd_unarmed_oam_bin, &banim_newwbrd_unarmed_oam_bin, &banim_newwbrd_unarmed_agbpal}, // 0x1AE wbrd unarmed
