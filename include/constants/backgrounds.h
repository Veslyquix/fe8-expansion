...
enum {
    ...
    BG_SEP_A_TORNADO_IN_THE_WILDERNESS_1835_THOMAS_COLE_192 = 0x3D,
    BG_SEP_AQUADUCT_THOMAS_COLE_192 = 0x3E,
    BG_SEP_AURORA_BOREALIS_FREDERIC_EDWIN_CHURCH_192 = 0x3F,
    BG_SEP_DISTANT_VIEW_OF_NIAGARA_FALLS_1830_THOMAS_COLE_192 = 0x40,
    BG_SEP_EXPULSION_FROM_THE_GARDEN_OF_EDEN_1828_THOMAS_COLE_192 = 0x41,
    BG_SEP_EXPULSION_MOON_AND_FIRELIGHT_THOMAS_COLE_192 = 0x42,
    BG_SEP_INTERIOR_OF_THE_COLOSSEUM_ROME_1832_THOMAS_COLE_192 = 0x43,
    BG_SEP_LAKE_WITH_DEAD_TREES_CATSKILL_THOMAS_COLE_192 = 0x44,
    BG_SEP_MOUNT_AETNA_FROM_TAORMINA_1843_THOMAS_COLE_192 = 0x45,
    BG_SEP_MOUNTAIN_SUNRISE_THOMAS_COLE_192 = 0x46,
    BG_SEP_PARTHENON_FREDERIC_EDWIN_CHURCH_192 = 0x47,
    BG_SEP_ROMANTIC_LANDSCAPE_WITH_RUINED_TOWER_THOMAS_COLE_192 = 0x48,
    BG_SEP_THE_ARABIAN_DESERT_FREDERIC_EDWIN_CHURCH_192 = 0x49,
    BG_SEP_THE_CASCATELLI_TIVOLI_THOMAS_COLE_192 = 0x4A,
    BG_SEP_THE_GARDEN_OF_EDEN_THOMAS_COLE_192 = 0x4B,
    BG_SEP_THE_NOTCH_OF_THE_WHITE_MOUNTAINS_CRAWFORD_NOTCH_THOMAS_COLE_192 = 0x4C,
    BG_SEP_THE_PAST_THOMAS_COLE_192 = 0x4D,
    BG_SEP_THE_SUBSIDING_OF_THE_WATERS_OF_THE_DELUGE_THOMAS_COLE_192 = 0x4E,
    BG_SEP_THOMAS_COLE_SCENE_FROM_THE_LAST_OF_THE_MOHICANS_192 = 0x4F,
    BG_SEP_TWILIGHTMOUNT_FREDERIC_EDWIN_CHURCH_192 = 0x50,
    BG_SEP_WHITE_MOUNTAIN_LANDSCAPE_MOUNT_WASHINGTON_MARTIN_JOHNSON_HEADE_192 = 0x51,
#endif
};
