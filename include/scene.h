...
void TalkSpriteShiftClear_OnInit(ProcPtr);
...
void SpriteTextScroll_OnInit(struct TalkDebugProc *);
void SpriteTextScroll_OnIdle(struct TalkDebugProc *);
void Nop_Scene_0(ProcPtr, int);
