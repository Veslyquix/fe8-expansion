...
def generate_exclusions_document(repo_root: Path, target_sha: str) -> Dict:
    ...
    return {
        "_comment": (
            ...
            "'generation_basis_sha' itself is a documentary record of which commit this file was "
            "last regenerated against ONLY -- it is never read, compared, or otherwise validated "
            "by any check in this repository (every check instead re-derives its own live "
            "target_sha -- HEAD, an explicit override, or the staged index -- independently); do "
            "not mistake its presence for a validated commit binding of any kind. Generated by "
